...
import EstabelecimentoIndicator from '../components/EstabelecimentoIndicator';
            ...
            <Suspense fallback={<div className="flex items-center justify-center min-h-screen">Carregando...</div>}>
                <Routes>
                    ...
                    <Route element={isAuthenticated ? <MainLayout /> : <Navigate to="/login" replace />}>
                        ...
                        <Route path="delivery" element={<RoleGuard allowedRoles={['admin', 'gerente', 'funcionario', 'caixa', 'estoquista']}><DeliveryPage /></RoleGuard>} />
