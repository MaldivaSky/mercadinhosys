  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Banco de Horas</h2>
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Controle de saldos de horas extras e devidas</p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-100 dark:border-gray-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Mês Referência</label>
            <select
              value={filtroMes}
                    ...
                    <tr key={r.id} className="hover:bg-gray-50 transition-colors">
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-medium text-gray-900 dark:text-white">{r.funcionario_nome}</span>
                        </div>
                      </td>
                      ...
                      <td className="px-4 py-3 text-center">
                        <span className={`px-2 py-1 text-xs font-bold rounded-full ${r.status === 'positivo' ? 'bg-green-100 text-green-700' :
