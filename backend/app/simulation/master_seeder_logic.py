...
class MasterSeeder:
    ...
    def run_master_generation(app, months=6, fetch_cosmos=False, reset_demo=False):
        ...
        print("  Gerente (nível 2).........: gerente1..gerente5 / gerente123")
        print("  RH (nível 3)..............: rh1..rh5 / rh123")
        print("  Caixa (nível 4)...........: caixa1..caixa5 / caixa123")
        print("  Estoquista (nível 4)......: estoque1..estoque5 / estoque123")
        print("  Vendedor (nível 5)........: rode seed_sfa.py (sfa_vend_a_<id> / 123456)")
        print("  Entrega (nível 6).........: entrega1..entrega5 / entrega123")
        print("-" * 60)
